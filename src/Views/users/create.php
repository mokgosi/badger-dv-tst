		    ...
		    <div class="col-md-8 col-md-offset-2">
		        <div class="">
		            ...
		            <div class="panel-body">
		            	...
		            	<form class="form-horizontal" action="store" method="post" data-parsley-validate="">
			                <div class="form-group">
				               	<label for="firstName" class="control-label col-sm-2">First Name</label>
							    <div class="col-sm-10">
							    	<input type="text" name="firstName" class="form-control  col-sm-4" required="" />
							    </div>
							</div>
							<div class="form-group">
				               	<label for="lastName" class="control-label col-sm-2">Last Name</label>
							    <div class="col-sm-10">
							    	<input type="text" name="lastName" class="form-control  col-sm-4" required="" />
							    </div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							    ...
							    <div class="col-sm-10">
							    	<input type="text" name="username" class="form-control  col-sm-4" required="" />
							    </div>
							</div>
							<div class="form-group">
							...
							<div class="button-group pull-right">
				               	<a href="index" class="btn btn-default btn-round-sm">Cancel</a>
								<button type="Submit" class="btn btn-success btn-round-sm"
									data-loading-text="<span class='glyphicon glyphicon-refresh' aria-hidden='true'></span> Submitting..."
									>Submit</button>
							</div>
		            	</form>
		            </div>
